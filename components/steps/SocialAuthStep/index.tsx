...
export const SocialAuthStep: React.FC = () => {
  const { onNextStep, onPreviousStep, onKeyBack, setUserData } = React.useContext(MainContext);
      ...
      <Div100vh className="centering">
        <HelperBlock>
          ...
          <div className={styles.btnsWrapper}>
            <Button disabled className={styles.twitterBtn} onClick={onClickAuth}>
              <svg className={styles.twitterLogo} width="16" height="14" fill="none">
                <path
            ...
            <Button onClick={onClickAuth} className={styles.githubBtn}>
              <svg className={styles.githubLogo} width="16" height="16" viewBox="0 0 24 24">
                <path
